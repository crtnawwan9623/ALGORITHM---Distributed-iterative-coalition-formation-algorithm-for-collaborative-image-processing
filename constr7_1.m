% This m-file contruct the strucutre of whole system,used for iteration3_1.m
...
N=randi(3,1,T)*1e6;
%N=[2e6,2e6,2e6]; %fix task property for 3_1 to smoothen the output curve
...
% D=zeros(1,T);
% for i=1:T
%     D(i)=0.8*sum(R_sys)/T/sum(s_sys(:,i));
% end

D=[0.2712    0.2745    0.2479];
%D=[0.2645,0.2645,0.2645] %fix task property for 3_1 to smoothen the output curve

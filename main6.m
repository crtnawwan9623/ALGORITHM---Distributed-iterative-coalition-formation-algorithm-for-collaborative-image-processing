% this m-file is for iteration6_int.m
...
while Cont == 1 && Coa_num > 1
    ...
    t1=toc;
    if t1> 1800 && Cont == 1 && Coa_num > 1 % more than 30min=1800s, main2 has stuck 
        q_stuck=1;
        break;
    end
end
...
if q_stuck == 0
    ...
    del_rt=[];
    for z=1:Coa_num
        [rvu_sc,pay_sc,tkc_sc,ekc_sc,Fkc_sc,x_sc]=Sep_coa6(Coa_str(z,:));
        deliver_rate;
        clg_tmp=(Coa_str(z,:)==1);
